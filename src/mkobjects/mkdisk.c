...
{
    char           *cmdformat = "%s n R0 R z M Vdisp Omega Xoff Yoff Zoff VXoff VYoff VZoff u\n";
...
main(int argc, const char *argv[])
{
    if (argc < 2) {
        ...
        double          offset[3];
        double          voffset[3];
        offset[0] = atof(argv[8]);
        offset[1] = atof(argv[9]);
        offset[2] = atof(argv[10]);
        voffset[0] = atof(argv[11]);
        voffset[1] = atof(argv[12]);
        voffset[2] = atof(argv[13]);
        u = atof(argv[14]);
